...
START_OF_RESEARCH = date(2025, 5, 11)
END_OF_RESEARCH = date(2025, 5, 20)

# ==============================================================================
# 2. *** NEW: COST CONTROL ***
# ==============================================================================
# This new variable limits how many pages of results we get for each day.
...
def run_full_collection_for_industry(industry_name, industry_query, api_key):
    ...
    while current_date <= END_OF_RESEARCH:
        ...
        time.sleep(2) # Small pause between days
